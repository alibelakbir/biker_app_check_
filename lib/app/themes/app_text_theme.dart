...
extension AppFontColor on TextStyle {
  ...
  TextStyle get primaryColor => copyWith(color: AppColors.kPrimaryColor);

  TextStyle get grayColor => copyWith(color: AppColors.gray);

  TextStyle get kLightTextColor => copyWith(color: AppColors.kLightTextColor);
